...
static void arrayCopy16BitPrimitiveInlineSmallSizeWithoutREPMOVS(TR::Node* node,
                                                                 TR::Register* dstReg,
                                                                 TR::Register* srcReg,
                                                                 TR::Register* sizeReg,
                                                                 TR::CodeGenerator* cg,
   ...
   arrayCopy16BitPrimitiveInlineSmallSizeWithoutREPMOVSImplRoot16(node, dstReg, srcReg, sizeReg, tmpReg1, tmpReg2, tmpXmmYmmReg1, tmpXmmYmmReg2, cg, repMovsThresholdBytes, mainEndLabel);
   ...
   if (isShortConstArrayWithDirection)
      ...
      if (elementSize == 8 && cg->comp()->target().is32Bit())
         ...
         if (enable16BitPrimitiveArrayCopyInlineSmallSizeWithoutREPMOVS)
            arrayCopy16BitPrimitiveInlineSmallSizeWithoutREPMOVS(node, dstReg, srcReg, sizeReg, cg, repMovsThresholdBytes);
         else
