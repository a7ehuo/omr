...
static void arrayCopy16BitPrimitiveInlineSmallSizeWithoutREPMOVSImplRoot16(TR::Node* node,
   ...
   generateRegImmInstruction(TR::InstOpCode::CMPRegImm4(), node, sizeReg, repMovsThresholdBytes, cg);
   generateLabelInstruction(TR::InstOpCode::JA4, node, repMovsLabel, cg);
...
static void arrayCopy16BitPrimitiveInlineSmallSizeWithoutREPMOVSLargeSizeREPMOVSD(TR::Node* node, TR::Register* dstReg, TR::Register* srcReg, TR::Register* sizeReg, TR::CodeGenerator* cg, int repMovsThresholdBytes)
   {
...
static bool enablePrimitiveArrayCopyInlineSmallSizeWithoutREPMOVS(uint8_t elementSize, TR::CodeGenerator* cg, int& threshold)
   ...
   static bool enablePrimitiveArrayCopyInlineSmallSizeWithoutREPMOVSOriginalThreshold = feGetEnv("TR_EnablePrimitiveArrayCopyInlineSmallSizeWithoutREPMOVSOriginalThreshold") != NULL;
   ...
   if (enablePrimitiveArrayCopyInlineSmallSizeWithoutREPMOVSOriginalThreshold ||
       cg->comp()->getOption(TR_EnablePrimitiveArrayCopyInlineSmallSizeWithoutREPMOVSOriginalThreshold))
      {
