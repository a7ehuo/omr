...
#define shortConstArrayWithoutDirThreshold  16*4
   ...
   if (isShortConstArrayWithDirection)
      ...
      if (elementSize == 8 && cg->comp()->target().is32Bit())
         ...
         {
         static bool disableArrayCopy16BitPrimitiveEnhancement = feGetEnv("TR_DisableArrayCopy16BitPrimitiveEnhancement") != NULL;

         bool enableArrayCopy16BitPrimitiveEnhancement = (!disableArrayCopy16BitPrimitiveEnhancement &&
