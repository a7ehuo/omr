...
TR::OptionTable OMR::Options::_jitOptions[] = {
   ...
   {"enableIntArrayCopyInlineLargeSizeWithoutREPMOVS", "O\tenable inline copy for int array using a loop ",      SET_OPTION_BIT(TR_Enable32BitPrimitiveArrayCopyInlineLargeSizeWithoutREPMOVS), "F"},
   ...
   {"enableLongArrayCopyInlineLargeSizeWithoutREPMOVS", "O\tenable inline copy for long array using a loop ",      SET_OPTION_BIT(TR_Enable64BitPrimitiveArrayCopyInlineLargeSizeWithoutREPMOVS), "F"},
